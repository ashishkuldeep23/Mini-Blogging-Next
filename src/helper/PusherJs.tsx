...
export default function PusherTestDiv({
  channelName,
}: {
  channelName: string;
}) {
  ...
  return (
    ...
    >
          ...
          <div key={index}>
            <div className=" text-center">
              {typeof item === "string" ? (
                ...
                <div className=" flex gap-1 bg-violet-950 ">
                  {/* <p>{JSON.stringify(item)}</p> */}
                  <p>
                    {item?.username + " : " + item.message + " : " + item?.room}
                  </p>
                  {/* <p>{item?.username}</p>
                  <p>{item?.message}</p>
                  <p>{item?.room}</p> */}
                ...
                <p>{item?.username + " " + item.message + " " + item?.room}</p>
              )}
            </div>
          </div>
        );
      ...
      <input
        ...
        className={`m-1 px-2 rounded-md border border-white  ${
